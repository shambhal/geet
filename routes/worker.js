...
exports.retrieve=function (req,res)
{
	...
	modelWorker.paginate(params,{page:current_page,limit:10,sort:{_id:-1} ,select:'name  _id mobile'},function (error,cursor)
		{
